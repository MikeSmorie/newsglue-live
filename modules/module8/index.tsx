    ...
    return (
      <div className="container max-w-7xl mx-auto p-6">
        <div className="text-center py-12">
          <BarChart3 className="mx-auto h-16 w-16 text-foreground mb-4" />
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <div className="flex items-center gap-1">
                      <p className="text-sm font-medium text-foreground dark:text-foreground">Total Outputs</p>
                      <UITooltip>
                        <TooltipTrigger>
                          <HelpCircle className="h-3 w-3 text-foreground" />
                        </TooltipTrigger>
                        <TooltipContent className="bg-gray-900 text-white border-gray-700">
                          <p className="text-sm">Total number of NewsJack outputs generated by the system for this campaign.</p>
                        </TooltipContent>
                      </UITooltip>
                    </div>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="flex items-center gap-1">
                      <p className="text-sm font-medium text-foreground dark:text-foreground">Time Saved</p>
                      <UITooltip>
                        <TooltipTrigger>
                          <HelpCircle className="h-3 w-3 text-foreground" />
                        </TooltipTrigger>
                        <TooltipContent className="bg-gray-900 text-white border-gray-700">
                          <p className="text-sm">Cumulative time saved versus average human writing time per post (estimated 15–45 min/post).</p>
                        </TooltipContent>
                      </UITooltip>
                    </div>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="flex items-center gap-1">
                      <p className="text-sm font-medium text-foreground dark:text-foreground">Cost Saved</p>
                      <UITooltip>
                        <TooltipTrigger>
                          <HelpCircle className="h-3 w-3 text-foreground" />
                        </TooltipTrigger>
                        <TooltipContent className="bg-gray-900 text-white border-gray-700">
                          <p className="text-sm">Estimated savings based on the time saved and your configured hourly rate ($/hour).</p>
                        </TooltipContent>
                      </UITooltip>
                    </div>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="flex items-center gap-1">
                      <p className="text-sm font-medium text-foreground dark:text-foreground">Efficiency</p>
                      <UITooltip>
                        <TooltipTrigger>
                          <HelpCircle className="h-3 w-3 text-foreground" />
                        </TooltipTrigger>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-1">
                    <span className="text-sm text-foreground dark:text-foreground">Compliance Score</span>
                    <UITooltip>
                      <TooltipTrigger>
                        <HelpCircle className="h-3 w-3 text-foreground" />
                      </TooltipTrigger>
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-1">
                    <span className="text-sm text-foreground dark:text-foreground">CTA Presence</span>
                    <UITooltip>
                      <TooltipTrigger>
                        <HelpCircle className="h-3 w-3 text-foreground" />
                      </TooltipTrigger>
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-1">
                    <span className="text-sm text-foreground dark:text-foreground">Quality Rating</span>
                    <UITooltip>
                      <TooltipTrigger>
                        <HelpCircle className="h-3 w-3 text-foreground" />
                      </TooltipTrigger>
